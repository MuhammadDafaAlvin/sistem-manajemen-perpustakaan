...
@section('content')
  <div class="bg-[#1a1a1a] shadow sm:rounded-3xl mt-4">
    <div class="px-8 py-10 rounded-t-3xl">
      <h3 class="text-3xl font-bold text-white tracking-tight">Tambah Penulis</h3>
      <p class="mt-2 text-base text-gray-400">Isi formulir berikut untuk menambahkan penulis baru ke sistem.</p>
    </div>
    <form action="{{ route('authors.store') }}" method="POST" class="px-4 py-5 sm:p-6">
      ...
      <div class="grid grid-cols-1 gap-6">
        ...
        <div>
          <label for="biography" class="block text-sm font-medium text-gray-300">Biografi</label>
      ...
      <div class="mt-6 flex justify-end space-x-4">
        <a href="{{ route('authors.index') }}"
          class="inline-flex items-center px-4 py-2 border border-gray-600 text-sm font-medium rounded-xl text-gray-300 bg-[#1a1a1a] hover:bg-gray-800">Batal</a>
        <button type="submit"
