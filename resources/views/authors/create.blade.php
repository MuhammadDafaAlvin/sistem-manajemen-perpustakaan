...
@section('content')
  <div class="bg-white shadow sm:rounded-3xl mt-4">
    <div class="px-8 py-10 bg-gradient-to-r from-gray-50 to-gray-400 rounded-t-3xl">
      <h3 class="text-3xl font-bold text-gray-900 tracking-tight">Tambah Penulis</h3>
      <p class="mt-2 text-base text-gray-600">Isi formulir berikut untuk menambahkan penulis baru ke sistem.</p>
    </div>
