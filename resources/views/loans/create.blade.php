...
@section('content')
  <div class="max-w-7xl mx-auto bg-white rounded-2xl overflow-hidden mt-4">
    <div class="px-8 py-10 bg-gradient-to-r from-gray-50 to-gray-400 rounded-t-2xl">
      <h3 class="text-3xl font-bold text-gray-900 tracking-tight">Tambah Peminjaman</h3>
      <p class="mt-2 text-base text-gray-600">Isi formulir berikut untuk menambahkan peminjaman baru ke sistem.</p>
    </div>
    <form action="{{ route('loans.store') }}" method="POST" class="px-4 py-5 sm:p-6">
      @csrf
