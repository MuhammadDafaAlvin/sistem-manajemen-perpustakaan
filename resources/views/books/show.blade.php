...
@section('content')
  <div class="max-w-3xl mx-auto bg-[#1a1a1a] shadow-lg rounded-2xl overflow-hidden mt-10">
    ...
    <div class="px-6 py-10 sm:px-8 sm:py-10">
      ...
      <div class="mt-8 flex justify-end">
        <a href="{{ route('books.public') }}"
          class="inline-flex items-center px-5 py-2.5 border border-gray-200 text-sm font-medium rounded-lg text-gray-300 bg-white hover:bg-gray-50 transition duration-150 ease-in-out">
          <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBo4000 0 24 24">
